...
public class SketchHistogram extends PApplet {
    ...
    public void drawAxis() {
        ...
        for (int y = 0; y<ytick; y++) {
            ...
            textSize(14);
            fill(0);
            text(GrahphingMethods.sigfigs(yAxisUB - yScale*y,2),tickBegin,relY);
        }
        //xaxis
        textAlign(LEFT, TOP);
        float theta = PI/3;
        for (int x = 0; x<xtick; x++) {
            ...
            text(GrahphingMethods.sigfigs(xAxisLB + xScale*x,2),0,0);
            popMatrix();
        }
    }
    ...
    public void drawAxis(PGraphics pg) {
        ...
        for (int y = 0; y<ytick; y++) {
            ...
            pg.textSize(14);
            pg.fill(0);
            pg.text(GrahphingMethods.sigfigs(yAxisUB - yScale*y,2),tickBegin,relY);
        }
        //xaxis
        ...
        for (int x = 0; x<xtick; x++) {
            ...
            pg.text(GrahphingMethods.sigfigs(xAxisLB + xScale*x,2),0,0);
            pg.popMatrix();
        }
        pg.endDraw();
    }
